...
# Fórmula do cálculo do preço utilizando fórmula de Black-Scholes
...
sigma_teste = 0.03 # Volatilidade teórica
T_teste = 5       # Tempo para expiração
t_teste = 0       # Tempo atual
